...
class MealV2Adapter extends TypeAdapter<_$MealImpl> {
  @override
  final int typeId = 6;

  @override
  _$MealImpl read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, _$MealImpl obj) {
    writer
      ..writeByte(16)
      ..writeByte(0)
      ..write(obj.id)
